  ...
  return (
    ...
    <div className="container flex">
      <div className='p-5 m-5'>
       ...
       <button className="bg-blue-600 text-white px-4 py-2 rounded-md">Download</button>
    </div>
      
      <form className='bg-white mt-5 ml-10 mr-10 border-1 border-gray-400 rounded-md'>
        <h2 className='text-xl p-5 m-5'>Website URL</h2>
        <label className='text-lg p-5 m-5'>Enter URL</label><br />
      ...
      <form className='bg-white mt-5 ml-10 mr-10 border-1 border-gray-400 rounded-md'>
        ...
        <label className='text-lg p-5 m-5'>Enter URL</label><br />
        <input className='p-5 m-5 w-lg h-10 hover:border-gray-100' type='url' placeholder='http;//letusgo,com' />
      </form>
      <form className='bg-white mt-5 ml-10 mr-10 border-1 border-gray-400 rounded-md'>
        <h2 className='text-xl p-5 m-5'>Logo</h2>
        <label className='text-lg p-5 m-5'>Uploaded Logo</label><br />
        <input className='p-5 m-5 w-lg h-10 border-gray-400 hover:border-gray-100' type='file' placeholder='http;//letusgo,com' />
        <h2 className='text-lg p-5 m-5'>Or Choose from here</h2>
      </form>
      <form className='bg-white mt-5 ml-10 mr-10 border-1 border-gray-400 rounded-md'>
        <h2 className='text-xl p-5 m-5'>Folder</h2>
        <label className='text-lg p-5 m-5'>Folder</label><br />
        {/* <input className='p-5 m-5 w-lg h-10 border-gray-400 hover:border-gray-100' type='url' placeholder='http;//letusgo,com' /> */}
        <select className='p-5 m-5 w-lg h-10 border-gray-400 hover:border-gray-100 ' placeholder="Event">
          <option></option>
        </select>
      </form>
