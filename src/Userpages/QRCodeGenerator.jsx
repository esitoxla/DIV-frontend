...
const QRCodeGenerator = () => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-6 rounded-md shadow-lg border">
      <h2 className="text-xl font-semibold mb-4">Name your QR code and share</h2>
      ...
      <div className="flex justify-between items-center mt-6 text-sm text-gray-600 border-t pt-3">
        <div className="flex items-center gap-2">
          <img src="https://api.qrserver.com/v1/create-qr-code/?data=http://kingvibes.com&size=30x30" alt="small qr" />
          <span>Track your code and see the scans on it</span>
        </div>
        <button className="border px-3 py-1 rounded-md text-sm hover:bg-gray-100">Track Scan</button>
      </div>
    </div>
  );
};
